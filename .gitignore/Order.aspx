<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Order.aspx.vb" Inherits="invoice.index" %>
...
<script language="javascript" type="text/javascript">
    ...
    function getListOfValue(dataArray, table) {
        ...
        if (table == "OrderHead") {
            ...
            setDirtyBit('DIRTY');
            document.getElementById('txtCustomerID').value = dataArray[0];
        }
        else if (table == "FillingGas") {
            setDirtyBit('DIRTY');
            document.getElementById('txtFillingGasNo').value = dataArray[0];
        }
        else if (table == "Product") {
            setDirtyBit('DIRTY');
            document.getElementById('<%= txtProductID.ClientID%>').value = dataArray[0];
        }
        else if (table == "Truck") {
            setDirtyBit('DIRTY');
            document.getElementById('<%= txtCompartmentNo.ClientID%>').value = dataArray[0];
        }
    ...
    function setMode(mode) {
     ...
     function calExtendedPrice() {
        var Quantity = parseFloat(document.getElementById('<%=txtOrderQuantity.ClientID%>').value); 
...
<body>
    ...
    <div id="main">
        ...
        <tr style="border:none">
            ...
            <td width="100%" align="right" style="border:none" bgcolor="Black"><h1>Order Form</h1></td>
        </tr>
        </table>
        </div>
        ...
        <tr height="32" >
            <td width="125"><span class="red_star">* </span><asp:Label ID="lbOrderNo" runat="server"></asp:Label>&nbsp;:</td>
            <td class="auto-style2"><asp:TextBox ID="txtOrderNo" runat="server" AutoPostBack="True" 
                    Width="80px"></asp:TextBox></td>   
            <td class="auto-style1"><asp:Label ID="lbOrderDate" runat="server"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="txtOrderDate" runat="server" AutoPostBack="True" 
                    Width="80px"></asp:TextBox></td>     
            <td width="130"><span class="red_star">* </span><asp:Label ID="lbFillingGasDate" runat="server"></asp:Label>&nbsp;:</td>
            <td width="145"><asp:TextBox ID="txtFillingGasDate" runat="server" AutoPostBack="True" 
                    Width="80px"></asp:TextBox></td>
        </tr>
        <tr >
            <td class="auto-style3"><span class="red_star">* </span><asp:Label ID="lbCustomerID" runat="server"></asp:Label>&nbsp;:</td> 
            <td class="auto-style4"><asp:TextBox ID="txtCustomerID" runat="server" AutoPostBack="True" Width="80px"></asp:TextBox>
                <asp:ImageButton ID="btnGetCustomer" runat="server" Height="20px" ImageUrl="~/image/btnSearch.png" CssClass="example4demo" /></td>     
            <td class="auto-style5"><asp:Label ID="lbCustomerName" runat="server"></asp:Label>&nbsp; <asp:TextBox ID="txtCustomerName" runat="server" Width="119px"></asp:TextBox></td>  
            <td class="auto-style3"><span class="red_star">* </span>&nbsp;<asp:Label ID="lbFillingGasNo" runat="server"></asp:Label>:</td>
            <td class="auto-style3"><asp:TextBox ID="txtFillingGasNo" runat="server" Width="119px"></asp:TextBox>
                <asp:ImageButton ID="btnGetFill" runat="server" Height="20px" ImageUrl="~/image/btnSearch.png" CssClass="example4demo" /></td>
        </tr>
        <tr  height="32" >
            <td>&nbsp;</td>
        </tr>
        ...
        <asp:GridView ID="gridOrderLineItem" runat="server" CellPadding="4" 
        ...
        <tr>
           ...
           <td style="width:140px"><asp:Label ID="lbTotalWeight" runat="server"></asp:Label>&nbsp;:</td>
           <td><asp:TextBox ID="txtTotalWeight" runat="server"></asp:TextBox></td>
        </tr>
        <tr> 
            <td style="width:700px"></td>
            <td>&nbsp;</td> 
        ...
        <tr>
        <td>
        <asp:TextBox ID="txtProductID" runat="server" Width="140px" AutoPostBack="True" TabIndex="1"></asp:TextBox>
        <asp:ImageButton ID="btnGetProduct" runat="server" ImageUrl="~/image/btnSearch.png" 
                Height="20px" Width="20px" />
        </td>
        <td>
        <asp:TextBox ID="txtCompartmentNo" runat="server" Width="140px" AutoPostBack="True" TabIndex="1"></asp:TextBox>
        <asp:ImageButton ID="btnGetCompart" runat="server" ImageUrl="~/image/btnSearch.png" 
                Height="20px" Width="20px" />
        </td>
        <td> 
        <asp:TextBox ID="txtOrderQuantity" runat="server" CssClass="disabled" Width="70px" TabIndex="2"
        onchange="javascript:calExtendedPrice(); setDirtyBit('DIRTY');"></asp:TextBox>
        </td>

<td> 
        <asp:TextBox ID="txtUnitPrice" runat="server" Width="70px"></asp:TextBox>
        </td>

<td> 
        <asp:TextBox ID="txtExtendedPrice" runat="server" Width="70px"></asp:TextBox>
        </td>
